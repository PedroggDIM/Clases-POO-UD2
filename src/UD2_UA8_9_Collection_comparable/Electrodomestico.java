...
Mayor que 80 kg	    100 € 
	...
	// método de implements compateTo().  se ordena por el método natural.
	// ordeno por consumo energético.
	@Override
	public int compareTo(Electrodomestico o) {
		int resultado;
		if(this.getConsumoEnergetico() > o.getConsumoEnergetico()) { // se pueden poner más criterios
			resultado = 1;
		}if(this.getConsumoEnergetico() < o.getConsumoEnergetico()) {
			resultado = -1;
		}else {
			resultado = 0;
		}		
