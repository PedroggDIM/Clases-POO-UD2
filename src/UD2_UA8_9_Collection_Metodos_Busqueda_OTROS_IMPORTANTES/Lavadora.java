...
public class Lavadora extends Electrodomestico {
	...
	/*
	 * // en la sulucion viene así(parece ser lo mismo) public Lavadora() {
	 * this(Electrodomestico.getPrecioBaseDef(), Electrodomestico.getPesoDef(),
	 * Electrodomestico.getConsumoEnergeticoDef(), Electrodomestico.getColorDef(),
	 * getCargaDef()); }
	 */
	...
	// metodo precioFinal() si tiene una carga mayor de 30 kg, aumentara el precio
	// 50 €,
